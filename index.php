                            ...
                            <div class="flex-grow-1 flex-part2">
                                ...
                                <p>
                                    <a href="single_post.php?id=<?= $result['blog_id'] ?>" id="body">
                                        ...
                                        <a href="single_post.php?id=<?= $result['blog_id'] ?>" class="btn btn-sm btn-outline-primary">Continue Reading</a></span>
                                </p>
                                <ul>
                                    <li class="me-2">
                                        <a href="">
            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <ul class="social-icons">
                        <li>
                            <a href="https://facebook.com/yourpage" class="social-icon" target="_blank">
                            <i class="fab fa-facebook" style="font-size: 20px;"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://twitter.com/yourhandle" class="social-icon" target="_blank">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/112dr-arti-verma-4760ba1b1/" class="social-icon" target="_blank">
                                <i class="fab fa-linkedin" style="font-size: 20px;"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.researchgate.net/profile/1112Arti-Verma-9" class="social-icon" target="_blank">
                                <i class="fab fa-researchgate" style="font-size: 20px;"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/@11111spreadingayurveda2601" class="social-icon" target="_blank">
...
<!-- Space after Social Links Section -->
<div class="container mt-4"> <!-- Adjust the margin-top value for desired spacing -->
